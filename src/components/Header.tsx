...
import { Globe, Instagram, Linkedin, Twitter, User } from 'lucide-react';
import Logo from '../assets/images/logo.png';
import { useLanguage } from '../contexts/LanguageContext';
import AnimatedSection from './AnimatedSection';
import AnimatedButton from './AnimatedButton';
import Imgia from '../assets/images/banner-ia.jpg';
        ...
        <nav className="navbar navbar-expand-lg px-3 py-2 position-relative">
          ...
          >
            ...
            <div className="d-flex align-items-center gap-2 ms-lg-4 mt-3 mt-lg-0">
              <div>
                <button className='btn-dark border-pill btn'>Explore our services</button>
              </div>
              <div className='bg-rounded-light d-flex align-items-center gap-3 py-1 px-3 rouded-pill'>
        ...
        <div className="container">
          <div className="row align-items-center gy-5 flex-revers-mobile">
            <div className="col-lg-7">
              <AnimatedSection animation="fadeInLeft">
                ...
                <h1 className="hero-title mb-3">
                  <span>{t('home.innovate')}</span>
                  <span>{t('home.develop')}</span>
                  <span>{t('home.thrive')}</span>
                </h1>
            ...
            <div className="col-lg-5 text-center">
              <img src={Imgia} alt="IA" className='w-100' />
            </div>
          </div>
        </div>
      </section>
